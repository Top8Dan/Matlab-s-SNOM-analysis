...
opts.VariableNames = ["R", "C", "Run", "Depth","Z", "M", "O0A", "O0P", "O1A", "O1P", "O2A", "O2P", "O3A", "O3P", "O4A", "O4P", "O5A", "O5P", "VarName18"];
opts.VariableTypes = ["double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double","double", "string"];
...
opts = setvaropts(opts, ["R", "C", "Run", "Depth","Z", "M", "O0A", "O0P", "O1A", "O1P", "O2A", "O2P", "O3A", "O3P", "O4A", "O4P", "O5A", "O5P"], "ThousandsSeparator", ",");
...
% Import the data
NFSpectraInterferogramsRaw = readtable("C:\Users\k68558dj\OneDrive - The University of Manchester\DataFiles\Lars-Visit Jul2024\2024-07-19 299 50K\2024-07-19 115549 NF S D-TGQ1-50K SiO2 readjusted PM\2024-07-19 115549 NF S D-TGQ1-50K SiO2 readjusted PM Interferograms.txt", opts);

% import Ref data
NFSpectraInterferogramsRawRef = readtable("C:\Users\k68558dj\OneDrive - The University of Manchester\DataFiles\Lars-Visit Jul2024\2024-07-19 299 50K\2024-07-19 115452 NF S D-TGQ1-50K Si readjusted PM\2024-07-19 115452 NF S D-TGQ1-50K Si readjusted PM Interferograms.txt", opts);

%Folder to Save in
SaveFolder = "C:\Users\k68558dj\OneDrive - The University of Manchester\DataFiles\Lars-Visit Jul2024\2024-07-19 299 50K\Analysis NFSpectra\4th Harmonic";
...
ZeroTable = array2table(ZeroArray,'VariableNames',["R", "C", "Run", "Depth","Z","M", "O0A", "O0P", "O1A", "O1P", "O2A", "O2P", "O3A", "O3P", "O4A", "O4P", "O5A", "O5P", "VarName18", "Complex"]);
